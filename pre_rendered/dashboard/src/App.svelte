...
<div class="parent">
  ...
  <div class="div2">
    <div class="option">
      ...
      <div class="selector">
        <button
          class={onComponent(Topitems)}
          onclick={() => nameChange(Topitems)}
        >
          Top Selling items
        </button>
        <button
          class={onComponent(Expireditems)}
          onclick={() => nameChange(Expireditems)}
        >
          Expired items
        </button>
        <button
          class={onComponent(Totalitembought)}
          onclick={() => nameChange(Totalitembought)}
        >
          Total Items Bought
        </button>
        <button
          class={onComponent(Totalitemsold)}
          onclick={() => nameChange(Totalitemsold)}
        >
          Total Items Sold
        </button>
        <button
        ...
        <button
          ...
          onclick={() => nameChange(Lowstock)}
        >
          Low Stock Items
        </button>
        <button
          class={onComponent(Profits)}
          onclick={() => nameChange(Profits)}
        >
          Profits
        </button>
        <button
          class={onComponent(Topcustomers)}
          onclick={() => nameChange(Topcustomers)}
        >
          Top Customers
        </button>
        <button
          class={onComponent(Topsuppliers)}
          onclick={() => nameChange(Topsuppliers)}
        >
          Top Suppliers
        </button>
      </div>
